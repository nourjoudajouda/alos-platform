...
<head>
    @php $landing = asset('landing'); $tenantUrl = url('/' . $tenant->slug); $portalLogin = url('/portal/login'); @endphp
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>{{ $settings->getDisplayName() }}</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="main-header__logo">
                        <a href="{{ $tenantUrl }}">
                            @if($settings->logo_url)
                                <img src="{{ $settings->logo_url }}" alt="{{ $settings->getDisplayName() }}" width="160">
                            @else
                                <img src="{{ $landing }}/assets/images/logo-dark-2.png" alt="{{ $settings->getDisplayName() }}" width="160">
                            @endif
                        </a>
                            ...
                            <div class="topbar-one__inner">
                                <ul class="list-unstyled topbar-one__info">
                                    ...
                                    <li class="topbar-one__info__item">
                                        <i class="fas fa-phone-alt topbar-one__info__icon"></i>
                        ...
                        <div class="main-header__center__bottom">
                            ...
                            <div class="main-header__center__right">
                                ...
                                <div class="main-header__btn">
                                    <a href="{{ $portalLogin }}" class="procounsel-btn">
                                        <i>Get started</i><span>Get started</span>
                                    </a><!-- /.thm-btn main-header__btn -->
                                    <div class="main-header__btn__border"></div>
                                    <a href="{{ $portalLogin }}" class="main-header__user">
        ...
        <section class=" main-slider-three" id="home">
            <div class="main-slider-three__carousel procounsel-owl__carousel owl-carousel" data-owl-options='{
		"loop": true,
		"animateOut": "fadeOut",
		"animateIn": "fadeIn",
		"items": 1,
		...
		"smartSpeed": 1000,
		"nav": true,
        "navText": ["<span class=\"icon-arrow-up\"></span>","<span class=\"icon-arrow-down\"></span>"],
		"dots": false,
		"margin": 0
	    }'>
                <div class="item">
                    <div class="main-slider-three__item">
                        <div class="main-slider-three__bg" style="background-image: url({{ $landing }}/assets/images/shapes/hero-banner-3-bg-shape.png);"></div>
                        <div class="container">
                            <div class="main-slider-three__content">
                                <h3 class="main-slider-three__sub__title">Looking for help from a Lawyer?</h3>
                                <h2 class="main-slider-three__title">
                                    We’ll stop at<br> nothing to fight<br> for justice
                                </h2><!-- slider-title -->
                                <div class="main-slider-three__btn">
                                    <a href="services.html" class="procounsel-btn">
                                        <i>Discover More</i>
                                        <span>Discover More</span>
                                    </a>
                                    <!-- slider-btn -->
                                </div>
                                <div class="main-slider-three__shape-one" style="background-image: url({{ $landing }}/assets/images/shapes/hero-banner-3-shape-1.png);"></div>
                            </div>
                        </div>
                        <div class="main-slider-three__img">
                            <div class="main-slider-three__img__inner">
                                <img src="{{ $landing }}/assets/images/resources/hero-banner-3-1.png" alt="banner">
                            </div>
                            <img src="{{ $landing }}/assets/images/resources/hero-banner-3-1-sign.png" alt="banner shape" class="main-slider-three__img-shape">
                            <div class="main-slider-three__img-shape-2"></div>
                            <div class="main-slider-three__img-shape-3"></div>
                        </div>
                    </div>
                </div><!-- item -->
            </div>
            ...
            </div><!-- main-slider-three__social -->
        </section>
        <!-- main-slider-end -->

        <section class="barnds-one barnds-three">
            <div class="container">
                    ...
                    "1200": {
                        ...
                        <div class="item">
                            <div class="barnds-one__img">
                                <img src="{{ $landing }}/assets/images/resources/brands-3-1.png" alt="">
                            </div>
                        </div>
                        <div class="item">
                            <div class="barnds-one__img">
                                <img src="{{ $landing }}/assets/images/resources/brands-3-2.png" alt="">
                            </div>
                        </div>
                        <div class="item">
                            <div class="barnds-one__img">
                                <img src="{{ $landing }}/assets/images/resources/brands-3-3.png" alt="">
                            </div>
                        </div>
                        <div class="item">
                            <div class="barnds-one__img">
                                <img src="{{ $landing }}/assets/images/resources/brands-3-4.png" alt="">
                            </div>
                        </div>
                        <div class="item">
                            <div class="barnds-one__img">
                                <img src="{{ $landing }}/assets/images/resources/brands-3-5.png" alt="">
                            </div>
                        </div>
                        <div class="item">
                            <div class="barnds-one__img">
                                <img src="{{ $landing }}/assets/images/resources/brands-3-6.png" alt="">
                            </div>
                        </div>
                    </div><!-- /.thm-owl__slider -->
                </div>
        ...
        <section class="about-four @@extraClassName" id="about">
            <div class="container">
                <div class="row gutter-y-30">
                    <div class="col-xl-4 col-md-12">
                        <div class="about-four__img bw-img-anim-left">
                            <img src="{{ $landing }}/assets/images/resources/about-3-1.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-8 col-md-12">
                        <div class="about-four__content">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title bw-split-in-up">Experience the <br> Best in <span>Legal Excellence</span></h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            <p class="about-four__text">
                                There are many variations of passages of one
                                Lorem Ipsum avalab but the majority have suffered alteration in some form, by injed humour words
                            ...
                            <div class="about-four__btns">
                                <a href="about.html" class="procounsel-btn ">
                                    <i> Discover More</i>
                                    <span> Discover More</span>
                                </a>
                                <img src="{{ $landing }}/assets/images/resources/about-2-signature.jpg" alt="signature">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="about-four__right">
                            <div class="about-four__right__inner">
                                <div class="about-four__count count-box">
                                    ...
                                    <p class="about-four__count__text">Years Of Experience</p>
                                </div>
                                <div class="about-four__count count-box">
                                    <h3 class="about-four__count__number">
                                    ...
                                    <p class="about-four__count__text">Online
                                        Consultation</p>
                                </div>
                                <div class="about-four__count count-box">
                                    <h3 class="about-four__count__number">
                                    ...
                                    <p class="about-four__count__text">Experience
                                        attorney</p>
                                </div>
                                <div class="about-four__count count-box">
                                    <h3 class="about-four__count__number">
                                    ...
                                    <p class="about-four__count__text">Won best
                                        Awards</p>
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="service-three__item wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-three__item__normal">
                                <div class="service-three__item__inner">
                                    ...
                                    <h3 class="service-three__item__title">
                                        <a href="service-d-criminal.html">Criminal Law</a>
                                    </h3><!-- /.service-title -->
                                    <p class="service-three__item__text">
                                        There are many free to variations of passages of Lorem Ipsum
                                    </p>
                                    <div class="service-three__item__image">
                                        <img src="{{ $landing }}/assets/images/resources/service-3-1.jpg" alt="procounsel">
                                        <a href="service-d-criminal.html" class="service-three__item__link">
                            ...
                            <div class="service-three__item__hover">
                                <div class="service-three__item__hover__inner" style="background-image: url({{ $landing }}/assets/images/resources/service-3-hover-1.jpg);">
                                    ...
                                    <a href="service-d-criminal.html" class="service-three__item__hover__link">
                                        <i class="icon-right-arrow-1-4"></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="service-three__item wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-three__item__normal">
                                <div class="service-three__item__inner">
                                    ...
                                    <h3 class="service-three__item__title">
                                        <a href="service-d-family.html">Family Law</a>
                                    </h3><!-- /.service-title -->
                                    <p class="service-three__item__text">
                                        There are many free to variations of passages of Lorem Ipsum
                                    </p>
                                    <div class="service-three__item__image">
                                        <img src="{{ $landing }}/assets/images/resources/service-3-2.jpg" alt="procounsel">
                                        <a href="service-d-family.html" class="service-three__item__link">
                                            <i class="icon-right-arrow-1-4"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="service-three__item__hover">
                                <div class="service-three__item__hover__inner" style="background-image: url({{ $landing }}/assets/images/resources/service-3-hover-2.jpg);">
                                    <div class="service-three__item__hover__icon">
                                        <i class="icon-family-law-1"></i>
                                    </div>
                                    <h3 class="service-three__item__hover__title">
                                    ...
                                    <a href="service-d-family.html" class="service-three__item__hover__link">
                                        <i class="icon-right-arrow-1-4"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="service-three__item wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-three__item__normal">
                                <div class="service-three__item__inner">
                                    <div class="service-three__item__icon">
                                        <i class="icon-dwelling-1"></i>
                                    </div>
                                    <h3 class="service-three__item__title">
                                        <a href="service-d-real-estate.html">Real Estate Law</a>
                                    </h3><!-- /.service-title -->
                                    <p class="service-three__item__text">
                                        There are many free to variations of passages of Lorem Ipsum
                                    </p>
                                    <div class="service-three__item__image">
                                        <img src="{{ $landing }}/assets/images/resources/service-3-3.jpg" alt="procounsel">
                                        <a href="service-d-real-estate.html" class="service-three__item__link">
                                            <i class="icon-right-arrow-1-4"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="service-three__item__hover">
                                <div class="service-three__item__hover__inner" style="background-image: url({{ $landing }}/assets/images/resources/service-3-hover-3.jpg);">
                                    <div class="service-three__item__hover__icon">
                                        <i class="icon-dwelling-1"></i>
                                    </div>
                                    <h3 class="service-three__item__hover__title">
                                    ...
                                    <a href="service-d-real-estate.html" class="service-three__item__hover__link">
                                        <i class="icon-right-arrow-1-4"></i>
                                    </a>
                                </div>
                            </div>
        ...
        <!-- Case Study -->
        <section class="case-study-three" id="caseStudy">
            <div class="case-study-three__bg jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% -100%" style="background-image: url({{ $landing }}/assets/images/backgrounds/case-study-3-bg.jpg);"></div>
            <div class="container">
                <div class="case-study-three__header">
                    <div class="sec-title text-left">
                        ...
                        <h3 class="sec-title__title bw-split-in-up">Our Recently Completed <br><span>Latest Case Study</span></h3><!-- /.sec-title__title -->
                    </div><!-- /.sec-title -->
                    <a href="project.html" class="procounsel-btn ">
                        <i>Discover More</i>
                        <span>Discover More</span>
                    </a>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-11">
                        <div class="procounsel-stretch-element-inside-column">
                            <div class="case-study-three__wrapper">
                                <div class="case-study-three__carousel procounsel-owl__carousel procounsel-owl__carousel--basic-nav owl-carousel" data-owl-options='{
                                "items": 1,
                                "margin": 30,
                                "loop": true,
                                "smartSpeed": 700,
                                ...
                                "responsive": {
                                    ...
                                    <div class="item">
                                        <div class="case-study-three__item">
                                            <img src="{{ $landing }}/assets/images/portfolio/case-3-1.jpg" alt="procounsel">
                                            <div class="case-study-three__item__bg"></div>
                                            <div class="case-study-three__item__content">
                                                <div class="case-study-three__item__cat">
                                                    <i class="icon-pin"></i>United State
                                                </div>
                                                <h3 class="case-study-three__item__title">
                                                    <a href="portfolio-details.html">Domestic Violence</a>
                                                </h3>
                                                <div class="case-study-three__item__rm">
                                                    <a href="portfolio-details.html"><i class="icon-right-arrow-1-4"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- item -->
                                    <div class="item">
                                        <div class="case-study-three__item">
                                            <img src="{{ $landing }}/assets/images/portfolio/case-3-2.jpg" alt="procounsel">
                                            <div class="case-study-three__item__bg"></div>
                                            <div class="case-study-three__item__content">
                                                <div class="case-study-three__item__cat">
                                                    <i class="icon-pin"></i>United State
                                    ...
                                    <div class="item">
                                        <div class="case-study-three__item">
                                            <img src="{{ $landing }}/assets/images/portfolio/case-3-3.jpg" alt="procounsel">
                                            <div class="case-study-three__item__bg"></div>
                                            <div class="case-study-three__item__content">
                                                <div class="case-study-three__item__cat">
                                                    <i class="icon-pin"></i>United State
                                    ...
                                    <div class="item">
                                        <div class="case-study-three__item">
                                            <img src="{{ $landing }}/assets/images/portfolio/case-3-4.jpg" alt="procounsel">
                                            <div class="case-study-three__item__bg"></div>
                                            <div class="case-study-three__item__content">
                                                <div class="case-study-three__item__cat">
                                                    <i class="icon-pin"></i>United State
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="faq-one__content">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title bw-split-in-up">Have Questions <br><span>in Your Mind?</span></h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            <div class="faq-one__accordion procounsel-accrodion" data-grp-name="procounsel-accrodion">
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <span class="accrodion__number"></span>
                                        <h4>
                                            What is attorney-client privilege?
                                            <i class="accrodion-title__icon"></i><!-- /.accrodion-title__icon -->
                                        </h4>
                                    </div><!-- /.accordian-title -->
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>
                                                ...
                                                have suffered alteradution some form by injected humour,
                                            </p>
                                ...
                                <div class="accrodion active">
                                    <div class="accrodion-title">
                                        <span class="accrodion__number"></span>
                                        <h4>
                                            Can a lawyer help get my charges reduced?
                                            <i class="accrodion-title__icon"></i><!-- /.accrodion-title__icon -->
                                        </h4>
                                    </div><!-- /.accordian-title -->
                                    <div class="accrodion-content">
                    ...
                    <div class="col-lg-6">
                        <div class="faq-one__img">
                            <img src="{{ $landing }}/assets/images/resources/faq-1-1.jpg" alt="faq" class="faq-one__img__one">
                            <img src="{{ $landing }}/assets/images/resources/faq-1-2.jpg" alt="faq" class="faq-one__img__two">
                            <img src="{{ $landing }}/assets/images/resources/faq-1-3.png" alt="faq" class="faq-one__img__three">
        ...
        <section class="why-choose-three">
            <div class="why-choose-three__bg" style="background-image: url({{ $landing }}/assets/images/shapes/why-choose-three-bg.png);"></div>
            <div class="why-choose-three__right wow slideInRight" style="background-image: url({{ $landing }}/assets/images/backgrounds/why-choose-three-bg.jpg);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-9">
                        <div class="why-choose-three__content wow fadeInUp" data-wow-delay="300ms">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title bw-split-in-up">Why You Should Choose <br><span> Our ProCounsel</span></h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            <div class="why-choose-three__box">
                                <div class="why-choose-three__box__left">
                                    <div class="why-choose-three__box__left-item">
                                        <div class="why-choose-three__box__left-icon">
                                            <i class="icon-right-arrow-1"></i>
                                        </div>
                                        <p class="why-choose-three__box__left-text">Knowledge of law and legal processes</p>
                                    </div>
                                    ...
                                    <div class="why-choose-three__box__left-item">
                                        ...
                                        <p class="why-choose-three__box__left-text">We represent your rights and interests</p>
                                    </div>
                                </div>
                                <div class="why-choose-three__box__right">
                                    <div class="why-choose-three__box__right-item">
                                        <p class="why-choose-three__box__right-text">We develop tailored strategies to achieve
                                ...
                                <div class="why-choose-three__box__icon">
        ...
        <section class="testimonials-three" id="testimonial">
            <div class="testimonials-three__bg" style="background-image: url({{ $landing }}/assets/images/shapes/testimonial-bg-3.png);"></div>
            <div class="container">
                <div class="testimonials-three__top">
                    <div class="sec-title text-left">
                        ...
                        <h3 class="sec-title__title bw-split-in-up">See What They Are <br><span>Talking About?</span></h3><!-- /.sec-title__title -->
                    </div><!-- /.sec-title -->
                    <div class="testimonials-three__info">
                        <div class="testimonials-three__info__rating">
                            <h3 class="testimonials-three__info__rating-value">4.6</h3>
                        ...
                        <div class="testimonials-three__info__content">
                            <h4 class="testimonials-three__info__title">Average Ratings</h4>
                            <p class="testimonials-three__info__text">(5k+) Customer <br> reviews</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="testimonials-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            ...
                            <div class="testimonials-card-three__text">
                                There are many variations of passages of Lorem Ipsum avalab but the majority have suffered alteration in some
                    ...
                    <div class="item">
                        <div class="testimonials-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            ...
                            <div class="testimonials-card-three__author">
                                <div class="testimonials-card-three__author-img">
                                    <img src="{{ $landing }}/assets/images/resources/testi-3-2.jpg" alt="">
                                </div>
                                <div class="testimonials-card-three__author-info">
                                    <h3 class="testimonials-card-three__name">
                                        Hena Wiano
                    ...
                    <div class="item">
                        <div class="testimonials-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            ...
                            <div class="testimonials-card-three__author">
                                <div class="testimonials-card-three__author-img">
                                    <img src="{{ $landing }}/assets/images/resources/testi-3-3.jpg" alt="">
                                </div>
                                <div class="testimonials-card-three__author-info">
                                    <h3 class="testimonials-card-three__name">
                                        Alen Martin
                    ...
                    <div class="item">
                        <div class="testimonials-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                            ...
                            <div class="testimonials-card-three__author">
                                <div class="testimonials-card-three__author-img">
                                    <img src="{{ $landing }}/assets/images/resources/testi-3-4.jpg" alt="">
                                </div>
                                <div class="testimonials-card-three__author-info">
                                    <h3 class="testimonials-card-three__name">
                                        Hena Wiano
                                    </h3><!-- /.testimonials-card-three__name -->
                                    <p class="testimonials-card-three__designation">Co Founder</p>
                                </div>
                                <!-- /.testimonials-card-three__designation -->
                            </div>
        ...
        <section class="cta-three" id="contact">
            <div class="container wow fadeInUp" data-wow-delay="200ms">
                <div class="cta-three__inner">
                    <div class="cta-three__inner__shape" style="background-image: url({{ $landing }}/assets/images/shapes/cta-shape-3-1.png);"></div>
                    <h3 class="cta-three__title">Get Trusted Legal Support <br>
                        Book Your Consultation Today</h3><!-- /.cta-three__title -->
                    <a href="{{ $portalLogin }}" class="procounsel-btn">
                        <i>Get started</i><span>Get started</span>
                    </a>
        ...
        <section class="blog-three" id="blog">
            <div class="container">
                <div class="sec-title text-center">
                    ...
                    <h3 class="sec-title__title bw-split-in-up">Latest News & Articles From <br><span>The Blog Posts</span></h3><!-- /.sec-title__title -->
                </div><!-- /.sec-title -->
                <div class="blog-three__carousel procounsel-owl__carousel procounsel-owl__carousel--with-shadow procounsel-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": false,
				"smartSpeed": 700,
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="blog-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="blog-card-three__image">
                                <img src="{{ $landing }}/assets/images/blog/blog-3-1.jpg" alt="10 Simple Practices that Will Help You Get 100% ">
                                <img src="{{ $landing }}/assets/images/blog/blog-3-1.jpg" alt="10 Simple Practices that Will Help You Get 100% ">
                                <a href="blog-details-right.html" class="blog-card-three__image__link"><span class="sr-only">10 Simple Practices that Will Help You Get 100% </span></a>
                            </div><!-- /.blog-card-three__image -->
                            <div class="blog-card-three__content">
                                <ul class="list-unstyled blog-card-three__meta">
                                    <li><i class="icon-calendar-two"></i>02 October, 2024</li>
                                    <li><i class="icon-bubble-chat-1"></i>05 Comments</li>
                                </ul><!-- /.list-unstyled blog-card-three__meta -->
                                <h3 class="blog-card-three__title"><a href="blog-details-right.html">10 Simple Practices that Will Help You Get 100% </a></h3>
                                <!-- /.blog-card-three__title -->
                                <div class="blog-card-three__bottom">
                                    <div class="blog-card-three__author">
                                        <img src="{{ $landing }}/assets/images/blog/blog-author-3-1.jpg" alt="Author" class="blog-card-three__author__img">
                                        <div class=" blog-card-three__author__info">
                                            <h3 class="blog-card-three__author__name"><a href="blog-list-right.html">Kristin Watson</a></h3>
                                            <span class="blog-card-three__author__designation">Admin</span>
                                        </div>
                                    </div>
                                    <a href="blog-details-right.html" class="procounsel-btn">
                                        <i>Read More</i><span>Read More</span>
                                    </a><!-- /.blog-card-three__link -->
                                </div>
                    ...
                    <div class="item">
                        <div class="blog-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            <div class="blog-card-three__image">
                                <img src="{{ $landing }}/assets/images/blog/blog-3-2.jpg" alt="Have Your Say In Shaping Health And Community">
                                <img src="{{ $landing }}/assets/images/blog/blog-3-2.jpg" alt="Have Your Say In Shaping Health And Community">
                                <a href="blog-details-right.html" class="blog-card-three__image__link"><span class="sr-only">Have Your Say In Shaping Health And Community</span></a>
                            </div><!-- /.blog-card-three__image -->
                            <div class="blog-card-three__content">
                                <ul class="list-unstyled blog-card-three__meta">
                                    <li><i class="icon-calendar-two"></i>02 October, 2024</li>
                                ...
                                <h3 class="blog-card-three__title"><a href="blog-details-right.html">Have Your Say In Shaping Health And Community</a></h3>
                                <!-- /.blog-card-three__title -->
                                <div class="blog-card-three__bottom">
                                    <div class="blog-card-three__author">
                                        <img src="{{ $landing }}/assets/images/blog/blog-author-3-1.jpg" alt="Author" class="blog-card-three__author__img">
                    ...
                    <div class="item">
                        <div class="blog-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            <div class="blog-card-three__image">
                                <img src="{{ $landing }}/assets/images/blog/blog-3-3.jpg" alt="Healthability Repair Cafe Makes Mark In Whitehorse">
                                <img src="{{ $landing }}/assets/images/blog/blog-3-3.jpg" alt="Healthability Repair Cafe Makes Mark In Whitehorse">
                                <a href="blog-details-right.html" class="blog-card-three__image__link"><span class="sr-only">Healthability Repair Cafe Makes Mark In Whitehorse</span></a>
                            </div><!-- /.blog-card-three__image -->
                            <div class="blog-card-three__content">
                                <ul class="list-unstyled blog-card-three__meta">
                                    <li><i class="icon-calendar-two"></i>02 October, 2024</li>
                                ...
                                <h3 class="blog-card-three__title"><a href="blog-details-right.html">Healthability Repair Cafe Makes Mark In Whitehorse</a></h3>
                                <!-- /.blog-card-three__title -->
                                <div class="blog-card-three__bottom">
                                    <div class="blog-card-three__author">
                                        <img src="{{ $landing }}/assets/images/blog/blog-author-3-1.jpg" alt="Author" class="blog-card-three__author__img">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-4 wow fadeInUp" data-wow-delay="00ms">
                            <div class="footer-widget footer-widget--about">
                                <a href="{{ $tenantUrl }}" class="footer-widget__logo">
                                    @if($settings->logo_url)
                                        <img src="{{ $settings->logo_url }}" width="160" alt="{{ $settings->getDisplayName() }}">
                                    @else
                                        <img src="{{ $landing }}/assets/images/logo-light.png" width="160" alt="{{ $settings->getDisplayName() }}">
                                    @endif
                                </a>
                        ...
                        <div class="col-md-6 col-xl-2 wow fadeInUp" data-wow-delay="200ms">
                            <div class="footer-widget footer-widget--links">
                                ...
                                <ul class="list-unstyled footer-widget__links">
                                    ...
                                    <li><a href="{{ $portalLogin }}">Client Portal</a></li>
                ...
                <div class="container">
                    <div class="main-footer__bottom__inner">
                        <p class="main-footer__copyright">
                            &copy; Copyright <span class="dynamic-year"></span> by {{ $settings->getDisplayName() }}.
                        </p>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="{{ $tenantUrl }}" aria-label="logo image">
                    @if($settings->logo_url)
                        <img src="{{ $settings->logo_url }}" width="155" alt="{{ $settings->getDisplayName() }}" />
                    @else
                        <img src="{{ $landing }}/assets/images/logo-light.png" width="155" alt="{{ $settings->getDisplayName() }}" />
                    @endif
                </a>
            </div>
            <!-- /.logo-box -->
