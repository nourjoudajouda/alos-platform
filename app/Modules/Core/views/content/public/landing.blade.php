...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
		...
		"margin": 0
                ...
                <div class="item">
                    <div class="main-slider-one__item">
                        <div class="main-slider-one__bg" style="background-image: url({{ $landing }}/assets/images/backgrounds/slider-1-1.jpg);"></div><!-- bg -->
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="main-slider-one__content">
                                        <h2 class="main-slider-one__title">The Legal <br />Defense Team <br />You Truly Deserve
                                        </h2><!-- slider-title -->
                                        <p class="main-slider-one__text">All the Lorem Ipsum generators on the Internet tend to
                                            repeat predefined <br />chunks as necessary</p><!-- slider-text -->
                                        <div class="main-slider-one__btn">
                                            <a href="{{ route('register') }}" class="procounsel-btn"> <i>Start Free Trial</i>
                                                <span>Start Free Trial</span></a><!-- slider-btn -->
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="item">
                    <div class="main-slider-one__item">
                        <div class="main-slider-one__bg" style="background-image: url({{ $landing }}/assets/images/backgrounds/slider-1-2.jpg);"></div><!-- bg -->
                        <div class="main-slider-one__overlay-one"></div>
                        <div class="main-slider-one__overlay-two"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="main-slider-one__content">
                                        ...
                                        <p class="main-slider-one__text">All the Lorem Ipsum generators on the Internet tend to
                                            repeat predefined <br />chunks as necessary</p><!-- slider-text -->
                                        <div class="main-slider-one__btn">
                                            <a href="{{ route('register') }}" class="procounsel-btn"> <i>Get Started</i>
                                                <span>Get Started</span></a><!-- slider-btn -->
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="item">
                    <div class="main-slider-one__item">
                        <div class="main-slider-one__bg" style="background-image: url({{ $landing }}/assets/images/backgrounds/slider-1-3.jpg);"></div><!-- bg -->
                        <div class="main-slider-one__overlay-one"></div>
                        <div class="main-slider-one__overlay-two"></div>
                        <div class="container">
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="about-one__image wow fadeInLeft " data-wow-delay="00ms">
                            <img src="{{ $landing }}/assets/images/resources/about-1-1.png" alt="procounsel">
                            <img src="{{ $landing }}/assets/images/resources/signature.png" alt="" class="about-one__image__signature">
                            <div class="about-one__image__left bw-img-anim-right">
                                <img src="{{ $landing }}/assets/images/resources/about-1-2.png" alt="procounsel">
                            </div>
                            ...
                            <div class="about-one__content">
                                ...
                                <div class="about-one__content__box">
                                    <div class="about-one__content__box__img bw-img-anim-left">
                                        <img src="{{ $landing }}/assets/images/resources/about-1-3.png" alt="">
                                    </div>
                                    <div class="d-flex flex-column justify-content-between align-items-start">
                                        <ul class="about-one__content__list">
                                            <li><span class="icon-check"></span>Many variations of passages </li>
                                            <li><span class="icon-check"></span>Many variations of passages</li>
                                            <li><span class="icon-check"></span>Expert many variations teacher </li>
                                        </ul>
                                        <a href="about.html" class="procounsel-btn"><i>Discover More</i><span>Discover
                                                More
                                            </span>
                                        </a>
                                    </div>
        ...
        <section class="service-one" id="services">
            <div class="service-one__bg" style="background-image: url({{ $landing }}/assets/images/shapes/service-bg-1.png);"></div>
            <div class="container-fluid">
                ...
                <div class="row gutter-y-30">
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                        <div class="service-one__item">
                            ...
                            <div class="service-one__item__image">
                                <img src="{{ $landing }}/assets/images/resources/service-1-1.png" alt="procounsel">
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="service-one__item">
                            ...
                            <div class="service-one__item__image">
                                <img src="{{ $landing }}/assets/images/resources/service-1-2.png" alt="procounsel">
                                <div class="service-one__item__icon">
                                    <i class="icon-family-law"></i>
                                </div>
                            </div>
                        </div><!-- /.service-card-one -->
                    </div><!-- item -->
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="service-one__item">
                            ...
                            <div class="service-one__item__image">
                                <img src="{{ $landing }}/assets/images/resources/service-1-3.png" alt="procounsel">
                                <div class="service-one__item__icon">
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="service-one__item">
                            ...
                            <div class="service-one__item__image">
                                <img src="{{ $landing }}/assets/images/resources/service-1-4.png" alt="procounsel">
                                <div class="service-one__item__icon">
                                    <i class="icon-employment-law"></i>
                                </div>
                            </div>
                        </div><!-- /.service-card-one -->
                    </div><!-- item -->
                                ...
                                "items": 6
                                        ...
                                        <div class="item">
                                            <div class="barnds-one__img">
                                                <img src="{{ $landing }}/assets/images/resources/brand-1.png" alt="">
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="barnds-one__img">
                                                <img src="{{ $landing }}/assets/images/resources/brand-2.png" alt="">
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="barnds-one__img">
                                                <img src="{{ $landing }}/assets/images/resources/brand-3.png" alt="">
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="barnds-one__img">
                                                <img src="{{ $landing }}/assets/images/resources/brand-4.png" alt="">
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="barnds-one__img">
                                                <img src="{{ $landing }}/assets/images/resources/brand-5.png" alt="">
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="barnds-one__img">
                                                <img src="{{ $landing }}/assets/images/resources/brand-6.png" alt="">
                                            </div>
                                        </div>
                                    </div><!-- /.thm-owl__slider -->
        ...
        <section class="why-choose-one">
            <div class="why-choose-one__bg" style="background-image: url({{ $landing }}/assets/images/backgrounds/why-choose-bg.jpg);"></div>
            <div class="container-fluid">
                <div class="row justify-content-center gutter-y-30">
                    <div class="col-xl-3">
                        <div class="why-choose-one__left">
                            <img src="{{ $landing }}/assets/images/resources/why-choose-1-2.jpg" alt="procounsel">
                        </div>
                    </div>
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="why-choose-one__content">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title bw-split-in-up">You Should Choose <br> <span>Our ProCounsel</span></h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            <p class="why-choose-one__text">
                                There are many variations passages to luck of Loem Ipsum available to but the majority have live
                                suffered alteration in
                            </p>
                            <a href="{{ route('register') }}" class="procounsel-btn ">
                                <i>Start Managing Your Clients</i>
                                <span>Start Managing Your Clients</span>
                            </a>
                            <div class="why-choose-one__item">
                                <div class="why-choose-one__experiance count-box">
                                    <h3 class="why-choose-one__experiance__count">
                                        <span class="count-text" data-stop="20" data-speed="1500"></span>
                                    </h3>
                                    <p class="why-choose-one__experiance__text">Years Of Experience</p>
                                </div>
                                <div class="why-choose-one__booking count-box">
                                    <h3 class="why-choose-one__booking__count">
                                        <span class="count-text" data-stop="15" data-speed="1500"></span>
                                    </h3>
                                    <p class="why-choose-one__booking__text">Online Booking</p>
                                </div>
                                <div class="why-choose-one__customers">
                                    <div class="why-choose-one__customers__item">
                                        <img src="{{ $landing }}/assets/images/resources/coustomer-1.jpg" alt="procounsel">
                                        <img src="{{ $landing }}/assets/images/resources/coustomer-2.jpg" alt="procounsel">
                                        <img src="{{ $landing }}/assets/images/resources/coustomer-3.jpg" alt="procounsel">
                                        <img src="{{ $landing }}/assets/images/resources/coustomer-4.jpg" alt="procounsel">
                                        <div class="why-choose-one__customers__total">5k+</div>
                                    </div>
                                    <h3 class="why-choose-one__customers__text">Satisfied Customers</h3>
                                </div>
                                <div class="why-choose-one__video">
                                    <h3 class="why-choose-one__video__text">Watch Story</h3>
                                    <div class="why-choose-one__video__img bw-img-anim-right">
                                        <img src="{{ $landing }}/assets/images/resources/why-choose-1-1.jpg" alt="procounsel">
                    ...
                    <div class="col-xl-3">
                        <div class="why-choose-one__right">
                            <img src="{{ $landing }}/assets/images/resources/why-choose-1-3.jpg" alt="procounsel">
                        </div>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container -->
        ...
        <!-- Portfolio Start -->
        <section class="portfolio-one" id="caseStudy">
            <div class="container">
                <div class="sec-title text-center">
            ...
            <div class="container">
                <div class="portfolio-one__wrapper">
                    <div class="portfolio-one__item">
                        <img src="{{ $landing }}/assets/images/portfolio/portfolio-1-1.jpg" alt="procounsel">
                        ...
                        <div class="portfolio-one__item__content">
                            <div class="portfolio-one__item__cat">
                    ...
                    <div class="portfolio-one__item">
                        <img src="{{ $landing }}/assets/images/portfolio/portfolio-1-2.jpg" alt="procounsel">
                        <div class="portfolio-one__item__rm">
                            <a href="portfolio-details.html"><i class="icon-right-arrow-1-4"></i></a>
                        </div>
                        <div class="portfolio-one__item__content">
                    ...
                    <div class="portfolio-one__item active">
                        <img src="{{ $landing }}/assets/images/portfolio/portfolio-1-3.jpg" alt="procounsel">
                        <div class="portfolio-one__item__rm">
                            <a href="portfolio-details.html"><i class="icon-right-arrow-1-4"></i></a>
                        </div>
                        <div class="portfolio-one__item__content">
        ...
        <section class="team-one">
            <div class="container">
                <div class="sec-title text-center">
                    ...
                    <h3 class="sec-title__title bw-split-in-up">Meet Our Experienced <br> <span>Attorney Lawyers</span></h3><!-- /.sec-title__title -->
                </div><!-- /.sec-title -->
                <div class="team-one__carousel procounsel-owl__carousel procounsel-owl__carousel--basic-nav owl-carousel" data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": false,
				"smartSpeed": 700,
                        ...
                        <div class="team-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            ...
                            <div class="team-card__image bw-img-anim-left">
                                <div class="team-card__content">
                                    ...
                                    <p class="team-card__designation">Lawyer</p><!-- /.team-card__designation -->
                                ...
                                <img src="{{ $landing }}/assets/images/team/team-1-1.jpg" alt="Mike Hardson">
                    ...
                    <div class="item">
                        <div class="team-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            ...
                            <div class="team-card__image bw-img-anim-left">
                                ...
                                <img src="{{ $landing }}/assets/images/team/team-1-2.jpg" alt="Jessica Brown">
                            </div><!-- /.team-card__image -->
                        </div><!-- /.team-card -->
                    </div><!-- /.item -->
                    <div class="item">
                        <div class="team-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            ...
                            <div class="team-card__image bw-img-anim-left">
                                <div class="team-card__content">
                                    <h3 class="team-card__title">
                                        <a href="team-details.html">David Coper</a>
                                    </h3><!-- /.team-card__title -->
                                    <p class="team-card__designation">Lawyer</p><!-- /.team-card__designation -->
                                ...
                                <img src="{{ $landing }}/assets/images/team/team-1-3.jpg" alt="David Coper">
                            </div><!-- /.team-card__image -->
                        </div><!-- /.team-card -->
                    </div><!-- /.item -->
                </div><!-- /.row -->
        ...
        <section class="testimonials-one" id="testimonial">
            <div class="testimonials-one__bg" style="background-image: url({{ $landing }}/assets/images/shapes/testimonials-1-bg.png);"></div>
            <div class="container">
                <div class="sec-title text-center">
                ...
                <div class="testimonials-one__carousel procounsel-owl__carousel  procounsel-owl__carousel--basic-nav owl-carousel" data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": false,
				"smartSpeed": 700,
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            <!-- <div class="testimonials-card__bg" style="background-image: url({{ $landing }}/assets/images/shapes/testi-card-bg-1-1.jpg);"></div> -->
                            <div class="testimonials-card__top">
                                <div class="testimonials-card__image bw-img-anim-right">
                                    <img src="{{ $landing }}/assets/images/resources/testi-1-1.jpg" alt="Alen Martin">
                            ...
                            <div class="testimonials-card__desc">
                                There are many variations passages to luck of Loem Ipsum available to but the majority have live by injected
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            ...
                            <div class="testimonials-card__top">
                                <div class="testimonials-card__image bw-img-anim-right">
                                    <img src="{{ $landing }}/assets/images/resources/testi-1-2.jpg" alt="Hena Wiano">
                                </div><!-- /.testimonials-card__image -->
                                <div class="testimonials-card__content">
                                    <div class="testimonials-card__quote">
                                        <i class="icon-quote"></i>
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            ...
                            <div class="testimonials-card__top">
                                <div class="testimonials-card__image bw-img-anim-right">
                                    <img src="{{ $landing }}/assets/images/resources/testi-1-3.jpg" alt="Keli Wiliam">
                                </div><!-- /.testimonials-card__image -->
                                <div class="testimonials-card__content">
                                    <div class="testimonials-card__quote">
                                        <i class="icon-quote"></i>
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                            ...
                            <div class="testimonials-card__top">
                                <div class="testimonials-card__image bw-img-anim-right">
                                    <img src="{{ $landing }}/assets/images/resources/testi-1-1.jpg" alt="Alice Genesis">
                                </div><!-- /.testimonials-card__image -->
                                <div class="testimonials-card__content">
                                    <div class="testimonials-card__quote">
                                        <i class="icon-quote"></i>
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            ...
                            <div class="testimonials-card__top">
                                <div class="testimonials-card__image bw-img-anim-right">
                                    <img src="{{ $landing }}/assets/images/resources/testi-1-2.jpg" alt="Alen Martin">
                                </div><!-- /.testimonials-card__image -->
                                <div class="testimonials-card__content">
                                    <div class="testimonials-card__quote">
                                        <i class="icon-quote"></i>
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            ...
                            <div class="testimonials-card__top">
                                <div class="testimonials-card__image bw-img-anim-right">
                                    <img src="{{ $landing }}/assets/images/resources/testi-1-3.jpg" alt="Hena Wiano">
                                </div><!-- /.testimonials-card__image -->
                                <div class="testimonials-card__content">
                                    <div class="testimonials-card__quote">
                                        <i class="icon-quote"></i>
        ...
        <section class="contact-one" id="contact">
            <div class="contact-one__bg" style="background-image: url({{ $landing }}/assets/images/backgrounds/contact-1-bg.jpg);"></div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <div class="contact-one__content">
                                <div class="contact-one__content__bg bw-img-anim-left" style="background-image: url({{ $landing }}/assets/images/resources/contact-1-1.jpg);"></div>
        ...
        <section class="blog-one" id="blog">
            <div class="container">
                ...
                <div class="blog-one__carousel procounsel-owl__carousel procounsel-owl__carousel--with-shadow procounsel-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": false,
				"smartSpeed": 700,
				...
				"responsive": {
                        ...
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="blog-card__content">
                                <div class="blog-card__user">
                                    <img src="{{ $landing }}/assets/images/blog/blog-user-1.jpg" alt="10 Simple Practices that Will Help You Get 1% " class="blog-card__user__img">
                                    <div class="blog-card__user__info">
                                        <h3 class="blog-card__user__name">Ronald Richards</h3>
                                        <p class="blog-card__user__designation">Admin</p>
                                    </div>
                                </div>
                                <h3 class="blog-card__title"><a href="blog-details-right.html">10 Simple Practices that Will Help You Get 1% </a></h3><!-- /.blog-card__title -->
                            </div><!-- /.blog-card__content -->
                            <div class="blog-card__image">
                                <div class="blog-card__image__inner">
                                    <img src="{{ $landing }}/assets/images/blog/blog-1-1.jpg" alt="10 Simple Practices that Will Help You Get 1% ">
                                    <img src="{{ $landing }}/assets/images/blog/blog-1-1.jpg" alt="10 Simple Practices that Will Help You Get 1% ">
                                    <a href="blog-details-right.html" class="blog-card__image__link"><span class="sr-only">10 Simple Practices that Will Help You Get 1% </span></a>
                                </div>
                                <div class="blog-card__date"><span>03</span>Feb</div><!-- /.blog-card__date -->
                            </div><!-- /.blog-card__image -->
                            <ul class="list-unstyled blog-card__meta">
                                <li><a href="blog-list-right.html">Read More</a></li>
                                <li><i class="icon-bubble-chat-1"></i>2 Comments</li>
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            <div class="blog-card__content">
                                <div class="blog-card__user">
                                    <img src="{{ $landing }}/assets/images/blog/blog-user-2.jpg" alt="We Can Aenean Poor leo Nec This Blog." class="blog-card__user__img">
                                    <div class="blog-card__user__info">
                                        <h3 class="blog-card__user__name">Ronald Richards</h3>
                                        <p class="blog-card__user__designation">Admin</p>
                                    </div>
                                </div>
                                <h3 class="blog-card__title"><a href="blog-details-right.html">We Can Aenean Poor leo Nec This Blog.</a></h3><!-- /.blog-card__title -->
                            </div><!-- /.blog-card__content -->
                            <div class="blog-card__image">
                                <div class="blog-card__image__inner">
                                    <img src="{{ $landing }}/assets/images/blog/blog-1-2.jpg" alt="We Can Aenean Poor leo Nec This Blog.">
                                    <img src="{{ $landing }}/assets/images/blog/blog-1-2.jpg" alt="We Can Aenean Poor leo Nec This Blog.">
                                    <a href="blog-details-right.html" class="blog-card__image__link"><span class="sr-only">We Can Aenean Poor leo Nec This Blog.</span></a>
                                </div>
                                <div class="blog-card__date"><span>03</span>Feb</div><!-- /.blog-card__date -->
                            </div><!-- /.blog-card__image -->
                            <ul class="list-unstyled blog-card__meta">
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            <div class="blog-card__content">
                                <div class="blog-card__user">
                                    <img src="{{ $landing }}/assets/images/blog/blog-user-3.jpg" alt="Aenean Sollicitudin Ieo Nunc, Ornare This Blog." class="blog-card__user__img">
                                    <div class="blog-card__user__info">
                                        <h3 class="blog-card__user__name">Ronald Richards</h3>
                                        <p class="blog-card__user__designation">Admin</p>
                                    </div>
                                </div>
                                <h3 class="blog-card__title"><a href="blog-details-right.html">Aenean Sollicitudin Ieo Nunc, Ornare This Blog.</a></h3><!-- /.blog-card__title -->
                            </div><!-- /.blog-card__content -->
                            <div class="blog-card__image">
                                <div class="blog-card__image__inner">
                                    <img src="{{ $landing }}/assets/images/blog/blog-1-3.jpg" alt="Aenean Sollicitudin Ieo Nunc, Ornare This Blog.">
                                    <img src="{{ $landing }}/assets/images/blog/blog-1-3.jpg" alt="Aenean Sollicitudin Ieo Nunc, Ornare This Blog.">
                                    <a href="blog-details-right.html" class="blog-card__image__link"><span class="sr-only">Aenean Sollicitudin Ieo Nunc, Ornare This Blog.</span></a>
                                </div>
                                <div class="blog-card__date"><span>03</span>Feb</div><!-- /.blog-card__date -->
                            </div><!-- /.blog-card__image -->
                            <ul class="list-unstyled blog-card__meta">
                ...
                <div class="container">
                    <div class="main-footer__bottom__inner">
                        <p class="main-footer__copyright">
                            &copy; Copyright <span class="dynamic-year"></span> by ALOS - Legal Office Management.
                        </p>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="{{ url('/') }}" aria-label="logo image"><img src="{{ $landing }}/assets/images/logo-light.png" width="155" alt="" /></a>
            </div>
            <!-- /.logo-box -->
