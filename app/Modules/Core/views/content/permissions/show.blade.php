...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
    ...
    <div class="d-flex gap-2">
      <a href="{{ route('core.permissions.edit', $permission) }}" class="btn btn-warning btn-sm">{{ __('Edit') }}</a>
      ...
      <dl class="row mb-0">
        ...
        <dd class="col-sm-9">
          @forelse($permission->roles as $r)
            <a href="{{ route('core.roles.show', $r) }}" class="badge bg-label-primary me-1 mb-1">{{ $r->name }}</a>
          @empty
