...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
    ...
    <div class="d-flex gap-2">
      <a href="{{ route('admin.core.permissions.show', $permission) }}" class="btn btn-outline-secondary btn-sm">{{ __('View') }}</a>
  ...
  <div class="card">
    <div class="card-body">
      <form action="{{ route('admin.core.permissions.update', $permission) }}" method="post">
        @csrf
        @method('PUT')
        <div class="mb-3">
