...
> نسخة للقراءة العادية (لو فتحت من `.cursor/plans/` وظهرت واجهة التخطيط المختصرة، افتح هذا الملف لرؤية المحتوى كاملاً).

---

## 1. السياق الحالي للمنصة

المشروع الحالي (alos-platform) عبارة عن **Laravel 12** مع Blade و Vite و Tailwind، وبدون:
